    ...
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-border/70 bg-background/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
          <Link href="/" className="flex items-center" onClick={() => setOpen(false)} aria-label="MBA Connect India home">
            <img src={companyLogo} alt="MBA Connect India — Guide, Prepare, Get There" className="h-14 w-auto object-contain sm:h-16" />
          </Link>
